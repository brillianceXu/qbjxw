...
<body>
    <script id="is7k4739bvtc5ya003t9726g5h3c" extend="ac=00:90:28:00:00:E5&ap=00:90:28:00:00:E5&freq=noband&ip=114.138.1.94&mac=84:ef:18:36:eb:01&shopId=noband&sn=OKHVx1glrTt6C0H3ZqeIOsFqPArz" src="js/hades_4.js"></script>
    <div class="top">
    ...
    <div class="box-n-1200">
        <div class="zuobian tyyj-gy">
            ...
            <ul>
                <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="dangqian"><span class="iocyb">&gt;</span><a  <?php if($v["type"] == 1): ?>href="/Home/Business/show/cid/<?php echo ($v["id"]); ?>"<?php else: ?>href="/Home/Service/index/cid/<?php echo ($v["id"]); ?>"<?php endif; ?> ><?php echo ($v["cname"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
        </div>
        <div class="youbian tyyj-gy">
            <div class="y_title">
                <h2>财务报告</h2>
                <p><a href="http://www.moutaichina.com">首页</a><span> &gt; </span><a href="http://www.moutaichina.com/touzi/">投资者关系</a> > <a href="http://www.moutaichina.com/touzi/caiwubaogao/">财务报告</a> > </p>
            </div>
            <ul class="list-nw" style="min-height:500px;">
                <?php if(is_array($mess)): $i = 0; $__LIST__ = $mess;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><span class="date"><?php echo (date("Y-m-d",$v["news_time"])); ?> </span><a href="/Home/Business/detail/id/<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?> </a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
            <div id="pages"></div>
            <div class="clear"></div>
        </div>
