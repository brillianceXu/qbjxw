...
<body>
    ...
    <div class="top-img" style="background-image: url(<?php echo ($banner['6']['route']); ?>);background-color: #A7BDCA;"></div>
    ...
    <div class="n-box">
        ...
        <div class="youbian" style="width: 846px;">
            ...
            <article class="col-main col-sm-12 col-xs-12">
                <div class="category-products">
                    <div class="row">
                        <?php if(is_array($mess)): $i = 0; $__LIST__ = $mess;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class='col-sm-4'>
                            <a href="/Home/Liquor/detail/id/<?php echo ($v["id"]); ?>.html" class='category'><span><img  class='small' src='<?php echo ($v["picture"]); ?>' style="width: 252px;height: 252px;" /></span>
                            <h4 style="text-align: center;"><?php echo ($v["name"]); ?></h4>
                            <p style="text-align: center;">价格:￥ <span style="color: red;"><?php echo ($v["price"]); ?></span> </p></a>
            ...
            <!-- <div id="pages" style="margin-top: 20px;"><a class="a1">68条</a> <a href="/pinpai/pinpaizhanlue/index.html" class="a1">上一页</a> <span>1</span> <a href="/pinpai/pinpaizhanlue/2.html">2</a> <a href="/pinpai/pinpaizhanlue/3.html">3</a> <a href="/pinpai/pinpaizhanlue/2.html" class="a1">下一页</a> <a class="a1">10页</a></div> -->
            <div class="clear"></div>
        </div>
        <div class="clear"></div>
    </div>
