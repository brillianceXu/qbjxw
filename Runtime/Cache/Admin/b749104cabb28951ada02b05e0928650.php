...
<div class="page-container" style="padding-top: 0px;">
  ...
  共有数据：<strong><?php echo ($article_count); ?></strong> 条</span> 
  </div>
  ...
  <table class="table table-border table-bordered table-bg table-hover table-sort">
    ...
    <tbody> 
      <?php if(is_array($log)): $i = 0; $__LIST__ = $log;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c">
        ...
        <td><?php if($v["status"] == 1): ?>成功<?php else: ?>失败<?php endif; ?></td>
        <td><?php echo ($v["username"]); ?></td>
        <td><?php echo ($v["uip"]); ?></td>
...
.current{
  ...
  <span class="r">
    ...
    <?php if($page == 1): else: ?>
    <a href="/Admin/System/system_log/page/1" class="paginate_button previous disabled" aria-controls="DataTables_Table_0" data-dt-idx="0" tabindex="0" id="DataTables_Table_0_previous">首页</a>
    <a href="/Admin/System/system_log/page/<?php echo ($page-1); ?>" class="paginate_button previous disabled" aria-controls="DataTables_Table_0" data-dt-idx="0" tabindex="0" id="DataTables_Table_0_previous">上一页</a><?php endif; ?>
    <span>
    ...
    <a  href="/Admin/System/system_log/page/<?php echo ($page+1); ?>" class="paginate_button next disabled" aria-controls="DataTables_Table_0" data-dt-idx="2" tabindex="0" id="DataTables_Table_0_next">下一页</a>
    <a  href="/Admin/System/system_log/page/<?php echo ($totalPage); ?>" class="paginate_button next disabled" aria-controls="DataTables_Table_0" data-dt-idx="2" tabindex="0" id="DataTables_Table_0_next">尾页</a><?php endif; ?>
    </div>
  </span>
  </div>
  </div>
...
function datadel(){
  $("#del_form").attr("action","/Admin/System/datadel");
  $("#del_form").submit();
  ...
  //     $.get("/Admin/System/datadel",{del:del},function(msg){
  //       if(msg == '200'){
  //         layer.msg('已删除!',{icon: 5,time:1000},function(){
  //           location.reload();
  //         });
