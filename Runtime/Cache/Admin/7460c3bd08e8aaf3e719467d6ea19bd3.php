    ...
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd <?php if($controller_name == 'Content'): ?>style="display:block;"<?php endif; ?>>
                <ul>
                    <li ><a href="/Admin/Content/index/pid/1.html" data-title="企业概况" <?php if(($controller_name == 'Content') and ($action_name == 'about')): ?>style="font-weight:bold;font-style: italic;"<?php endif; ?>>企业概况</a></li>
                    <li ><a href="/Admin/Content/index/pid/3.html" data-title="新闻资讯" <?php if(($controller_name == 'Content') and ($action_name == 'index')): ?>style="font-weight:bold;font-style: italic;"<?php endif; ?>>新闻资讯</a></li>
                    <li ><a href="/Admin/Content/index/pid/4.html" data-title="服务中心" <?php if(($controller_name == 'Content') and ($action_name == 'culture')): ?>style="font-weight:bold;font-style: italic;"<?php endif; ?>>服务中心</a></li>
                    
                    <li ><a href="/Admin/Content/index/pid/5.html" data-title="合作者关系" <?php if(($controller_name == 'Content') and ($action_name == 'business')): ?>style="font-weight:bold;font-style: italic;"<?php endif; ?>>合作者关系</a></li>
                    <li ><a href="/Admin/Content/consult.html" data-title="在线咨询" <?php if(($controller_name == 'Content') and ($action_name == 'consult')): ?>style="font-weight:bold;font-style: italic;"<?php endif; ?>>在线咨询</a></li>
                    <li><a href="/Admin/Category/category_list.html" data-title="分类" href="javascript:void(0)" <?php if(($controller_name == 'Content') and ($action_name == 'category_list')): ?>style="font-weight:bold;font-style: italic;"<?php endif; ?>>分类栏目</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-System">
            ...
            <dd <?php if($controller_name == 'Goods'): ?>style="display:block;"<?php endif; ?>>
                <ul>
                    ...
                    <li><a href="/Admin/Goods/category_list.html" data-title="产品分类" href="javascript:void(0)" <?php if(($controller_name == 'Goods') and ($action_name == 'category_list')): ?>style="font-weight:bold;font-style: italic;"<?php endif; ?>>产品分类</a></li>
        ...
        <dl id="menu-System">
            ...
            <dd <?php if($controller_name == 'Banner'): ?>style="display:block;"<?php endif; ?>>
                <ul>
                    <li><a href="/Admin/Banner/index.html" data-title="Banner" href="javascript:void(0)" <?php if(($controller_name == 'Banner') and ($action_name == 'index')): ?>style="font-weight:bold;font-style: italic;"<?php endif; ?>>图片列表</a></li>
...
<section class="Hui-article-box">
    ...
    <div class="page-container">
        <form action="/Admin/Goods/index<?php echo ($str); ?>" method="get">
            <div class="text-c">
                ...
                <input type="text" name="keywords" id="" placeholder="<?php echo ((isset($keywords) && ($keywords !== ""))?($keywords):" 搜索标题或者内容 "); ?>" style="width:250px" class="input-text">
                <button name="" id="" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜索</button>
                <button name="" id="" class="btn btn-primary" type="button" onclick="window.location.href='/Admin/Goods/goods_add.html';"><i class="Hui-iconfont">&#xe600;</i> 添加</button>
            </div>
        </form>
        <!-- <a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> -->
        <!-- <a class="btn btn-primary radius" data-title="添加资讯" href="/Admin/Invest/invest_add.html"><i class="Hui-iconfont"></i> 添加</a></span> -->
        <!-- <a class="btn btn-secondary radius" data-title="视频新闻" href="/Admin/Content/video.html"><i class="Hui-iconfont">&#xe616;</i> 视频新闻</a></span> -->
        <span class="r"> &nbsp; &nbsp;共：<strong><?php echo ($totalPage); ?></strong> 页 &nbsp; &nbsp;共有数据：<strong><?php echo ($article_count); ?></strong> 条</span>
    </div>
    <div class="container">
    <div class="row clearfix">
        <div class="col-md-12 column">
            <div class="row">
                <?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="col-md-3" style="padding: 15px;">
                    <div class="thumbnail">
                        <img alt="300x200" src="<?php echo ($v["picture"]); ?>" style="width:100%;height: auto;" />
                        <div class="caption">
                            <h3>
                                <a href="/Admin/Goods/show.html"><?php echo ($v["name"]); ?></a>
                            </h3>
                            <p>
                                <?php echo ($v["summary"]); ?>
                            </p>
                            <p>
                                 <a class="btn btn-primary" href="#">上架</a> <a class="btn" href="#">相册</a> <a class="btn" href="#">详情……</a>
                            </p>
                        </div>
                    </div>
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20" style="line-height: 35px;">
		...
		<?php if($page == 1): else: ?>
		<a href="/Admin/Goods/index<?php echo ($str); ?>/page/1" class="paginate_button previous disabled" aria-controls="DataTables_Table_0" data-dt-idx="0" tabindex="0" id="DataTables_Table_0_previous">首页</a>
		<a href="/Admin/Goods/index<?php echo ($str); ?>/page/<?php echo ($page-1); ?>" class="paginate_button previous disabled" aria-controls="DataTables_Table_0" data-dt-idx="0" tabindex="0" id="DataTables_Table_0_previous">上一页</a><?php endif; ?>
		<span>
        ...
        <?php if($page == $totalPage): else: ?>
            <a href="/Admin/Goods/index<?php echo ($str); ?>/page/<?php echo ($page+1); ?>" class="paginate_button next disabled" aria-controls="DataTables_Table_0" data-dt-idx="2" tabindex="0" id="DataTables_Table_0_next">下一页</a>
            <a href="/Admin/Goods/index<?php echo ($str); ?>/page/<?php echo ($totalPage); ?>" class="paginate_button next disabled" aria-controls="DataTables_Table_0" data-dt-idx="2" tabindex="0" id="DataTables_Table_0_next">尾页</a><?php endif; ?>
    </div>
    </span>
    </div>
    </div>
