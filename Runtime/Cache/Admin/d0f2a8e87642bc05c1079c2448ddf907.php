...
<section class="Hui-article-box">
    ...
    <a class="btn btn-primary radius" data-title="添加" href="/Admin/Goods/category_add.html"><i class="Hui-iconfont">&#xe600;</i> 添加</a></div>
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tbody>
                <form method="post" action="/Admin/Goods/datadel" id="datadel_form">
...
function active_del(id){
	layer.confirm("确定要删除吗？",function(){
		$.get("/Goods/del_cate",{id:id},function(msg){
			if(msg == 200){
...
function do_sort(id){
	...
	$.get("/Goods/done_sort",{id:id,sort:sort},function(msg){
		if(msg == '200'){
				location.reload();
		}else{
