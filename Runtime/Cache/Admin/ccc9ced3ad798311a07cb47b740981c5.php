    ...
    <div class="page-container">
        <form action="/Admin/Content/consult<?php echo ($str); ?>.html" method="get">
            <div class="text-c">
                ...
                <!-- <a class="btn btn-primary" data-title="添加" href="/Admin/Content/article_add/pid/<?php echo ($pid); ?>.html"><i class="Hui-iconfont">&#xe600;</i> 添加</a> -->
                <button name="" id="" class="btn btn-primary" type="button" onclick="window.location.href='/Admin/Content/article_add/pid/<?php echo ($pid); ?>.html';"><i class="Hui-iconfont">&#xe600;</i> 添加</button>
            </div>
        </form>
		...
		每页：<strong>
			<span  class="select-box inline">
			<form action="/Admin/Content/index<?php echo ($str); ?>.html" method="get" id="PageForm">
                    ...
                    <?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c">
                           ...
                           <!--  <td>
                            ...
                            <td class="f-14 td-manage">
                                ...
                                <a style="text-decoration:none" class="ml-5" href="/Admin/Content/article_add/id/<?php echo ($v["id"]); ?>/pid/<?php echo ($pid); ?>.html" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
