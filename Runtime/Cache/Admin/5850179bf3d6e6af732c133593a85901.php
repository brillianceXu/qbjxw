				...
				<ul class="cl">
					<li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							...
							<li><a href="/Admin/Content/policy_add.html" ><i class="Hui-iconfont">&#xe613;</i> 政策</a></li>
    ...
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd <?php if($controller_name == 'Content'): ?>style="display:block;"<?php endif; ?>>
                <ul>
                    <li ><a href="/Admin/Content/index.html" data-title="新闻管理" <?php if(($controller_name == 'Content') and ($action_name == 'index')): ?>style="font-weight:bold;font-style: italic;"<?php endif; ?>>新闻管理</a></li>
                    ...
                    <li ><a href="/Admin/Content/culture.html" data-title="企业文化" <?php if(($controller_name == 'Content') and ($action_name == 'culture')): ?>style="font-weight:bold;font-style: italic;"<?php endif; ?>>企业文化</a></li>
                    <li ><a href="/Admin/Invest/index.html" data-title="投资促进" <?php if(($controller_name == 'Content') and ($action_name == 'invest')): ?>style="font-weight:bold;font-style: italic;"<?php endif; ?>>投资促进</a></li>
        ...
        <dl id="menu-System">
            ...
            <dd <?php if($controller_name == 'Banner'): ?>style="display:block;"<?php endif; ?>>
                <ul>
                    ...
                    <li><a href="/Admin/Banner/album.html" data-title="园区风采" href="javascript:void(0)" <?php if(($controller_name == 'Banner') and ($action_name == 'album')): ?>style="font-weight:bold;font-style: italic;"<?php endif; ?>>园区风采</a></li>
        ...
        <dl id="menu-System">
            <dt <?php if($controller_name == 'Category'): ?>class="selected" style="background:#5A98DE;color:white;"<?php endif; ?>><i class="Hui-iconfont">&#xe681;</i> 分类管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd <?php if($controller_name == 'Category'): ?>style="display:block;"<?php endif; ?>>
                <ul>
                    <li><a href="/Admin/Category/category_list.html" data-title="新闻分类" href="javascript:void(0)" <?php if(($controller_name == 'Category') and ($action_name == 'category_list')): ?>style="font-weight:bold;font-style: italic;"<?php endif; ?>>新闻分类</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-System">
...
<section class="Hui-article-box">
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 内容管理 <span class="c-gray en">&gt;</span> 投资促进</nav>
    <div class="page-container">
        <form action="/Admin/Invest/index/pageSize/<?php echo ($pageSize); ?>.html" method="get">
            <div class="text-c">
		...
		每页：<strong>
			...
			<form action="/Admin/Invest/index/<?php echo ($str); ?>.html" method="get" id="PageForm">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tbody>
                <form method="post" action="/Admin/Invest/datadel" id="datadel_form">
                    <?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c">
                           ...
                           <!--  <td>
                            ...
                            <td class=""><a href="/index.php/Home/Invest/detail/id/<?php echo ($v["id"]); ?>.html" target="_blank"><u style="cursor:pointer" class="text-primary"  title="查看"><?php echo ($v["title"]); ?></u></a></td>
                            ...
                            <td class="f-14 td-manage">
                                ...
                                <a style="text-decoration:none" class="ml-5" href="/Admin/Invest/invest_add/id/<?php echo ($v["id"]); ?>.html" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20" style="line-height: 35px;">
		...
		<?php if($page == 1): else: ?>
		<a href="/Admin/Invest/index<?php echo ($str); ?>/page/1" class="paginate_button previous disabled" aria-controls="DataTables_Table_0" data-dt-idx="0" tabindex="0" id="DataTables_Table_0_previous">首页</a>
		<a href="/Admin/Invest/index<?php echo ($str); ?>/page/<?php echo ($page-1); ?>" class="paginate_button previous disabled" aria-controls="DataTables_Table_0" data-dt-idx="0" tabindex="0" id="DataTables_Table_0_previous">上一页</a><?php endif; ?>
		<span>
        ...
        <?php if($page == $totalPage): else: ?>
            <a href="/Admin/Invest/index<?php echo ($str); ?>/page/<?php echo ($page+1); ?>" class="paginate_button next disabled" aria-controls="DataTables_Table_0" data-dt-idx="2" tabindex="0" id="DataTables_Table_0_next">下一页</a>
            <a href="/Admin/Invest/index<?php echo ($str); ?>/page/<?php echo ($totalPage); ?>" class="paginate_button next disabled" aria-controls="DataTables_Table_0" data-dt-idx="2" tabindex="0" id="DataTables_Table_0_next">尾页</a><?php endif; ?>
    </div>
    </span>
    </div>
    </div>
