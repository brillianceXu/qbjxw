...
<section class="Hui-article-box">
    ...
    <a class="btn btn-primary radius" data-title="添加" href="/Admin/Category/category_add/type/<?php echo ($type); ?>.html"><i class="Hui-iconfont">&#xe600;</i> 添加</a></div>
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tbody>
                <form method="post" action="/Admin/Content/datadel" id="datadel_form">
                    <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c">
                            <td>
                            ...
                            <td class=""><?php echo ($v["cname"]); ?></td>
                            <td><?php echo ($v["note"]); ?></td>
                            <td><?php echo ($v["pname"]); ?></td>
                            <td><?php if($v["type"] == 1): ?>列表<?php else: ?>文章<?php endif; ?></td>
...
function active_del(id){
	layer.confirm("确定要删除吗？",function(){
		$.get("/Category/del_cate",{id:id},function(msg){
			if(msg == 200){
...
function do_sort(id){
	...
	$.get("/Category/done_sort",{id:id,sort:sort},function(msg){
		if(msg == '200'){
				location.reload();
		}else{
