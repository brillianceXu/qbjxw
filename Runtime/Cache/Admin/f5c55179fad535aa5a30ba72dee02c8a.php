...
<section class="Hui-article-box">
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 系统管理 <span class="c-gray en">&gt;</span> 访问记录 </nav>
    <div class="page-container" style="padding-top: 20px;">
        <form action="/Admin/System/views.html" method="get" id="search_form">
            <div class="text-c"> 时间范围：
                <input type="text" id="logmin" name="start" class="input-text Wdate" style="width:186px;" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',readOnly:true})"> -
                <input type="text" id="logmax" name="end" class="input-text Wdate" style="width:186px;" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',readOnly:true})">&nbsp;&nbsp;
                <button onclick="do_search();" id="" class="btn btn-success" type="button"><i class="Hui-iconfont">&#xe665;</i>搜索</button>
            </div>
        </form>
        <!--  <form action="/Content/index/pageSize/<?php echo ($pageSize); ?>.html" method="get">
            <div class="text-c">
  ...
  共有数据：<strong><?php echo ($count); ?></strong> 条</span>
        </div>
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tbody>
                <?php if(is_array($mess)): $i = 0; $__LIST__ = $mess;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c">
                        <td>
                            <input type="checkbox" value="<?php echo ($v["id"]); ?>" name="del[]">
                        </td>
                        <td><?php echo ($v["id"]); ?></td>
                        <td><?php echo ($v["ip"]); ?></td>
                        <td><?php echo ($v["vtime"]); ?></td>
                        <!--        <td>
        <a title="删除" href="javascript:;" onclick="system_log_del(<?php echo ($v["id"]); ?>)" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td> -->
    ...
    <?php if($page == 1): else: ?>
    <a href="/Admin/System/views/page/1" class="paginate_button previous disabled" aria-controls="DataTables_Table_0" data-dt-idx="0" tabindex="0" id="DataTables_Table_0_previous">首页</a>
    <a href="/Admin/System/views/page/<?php echo ($page-1); ?>" class="paginate_button previous disabled" aria-controls="DataTables_Table_0" data-dt-idx="0" tabindex="0" id="DataTables_Table_0_previous">上一页</a><?php endif; ?>
    <span>
      <a class="paginate_button current" aria-controls="DataTables_Table_0" data-dt-idx="1" tabindex="0"><?php echo ($page); ?></a>
                ...
                <?php if($page == $totalPage): else: ?>
                    <a href="/Admin/System/views/page/<?php echo ($page+1); ?>" class="paginate_button next disabled" aria-controls="DataTables_Table_0" data-dt-idx="2" tabindex="0" id="DataTables_Table_0_next">下一页</a>
                    <a href="/Admin/System/views/page/<?php echo ($totalPage); ?>" class="paginate_button next disabled" aria-controls="DataTables_Table_0" data-dt-idx="2" tabindex="0" id="DataTables_Table_0_next">尾页</a><?php endif; ?>
            </div>
            </span>
        </div>
    </div>
