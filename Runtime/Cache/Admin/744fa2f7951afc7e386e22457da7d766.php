        ...
        <dl id="menu-article">
            ...
            <dd <?php if($controller_name == 'Content'): ?>style="display:block;"<?php endif; ?>>
                <ul>
                    ...
                    <li><a href="/Admin/Category/category_list/type/2.html" data-title="分类" href="javascript:void(0)" <?php if(($controller_name == 'Content') and ($action_name == 'category_list')): ?>style="font-weight:bold;font-style: italic;"<?php endif; ?>>分类栏目</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-System">
...
<section class="Hui-article-box">
    ...
    <div class="page-container">
        <form action="/Admin/Content/consult<?php echo ($str); ?>.html" method="get">
            <div class="text-c">
               <span class="select-box inline">
                <select name="status" class="select">
                    <option value="1" <?php if($status == 1): ?>selected="selected"<?php endif; ?>>未查看</option>
                    <option value="2" <?php if($status == 2): ?>selected="selected"<?php endif; ?>>已回复</option>
                    <option value="0" <?php if($status == 0): ?>selected="selected"<?php endif; ?>>已删除</option>
		...
		每页：<strong>
			<span  class="select-box inline">
			<form action="/Admin/Content/consult<?php echo ($str); ?>.html" method="get" id="PageForm">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tbody>
                <form method="post" action="/Admin/Content/datadel" id="datadel_form">
                    <?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c">
                           ...
                           <!--  <td>
                            ...
                            <td class=""><u style="cursor:pointer" class="text-primary"  title="<?php echo ($v["title"]); ?>"><?php echo ($v["title"]); ?></u></td>
                            <td><?php echo (date("Y-m-d H:i:s",$v["addtime"])); ?></td>
                            <!-- <td><?php echo ($v["update_time"]); ?></td> -->
                            <td><?php echo (mb_substr($v["content"],0,25,'uft-8')); ?>...</td>
                            <td><?php if($v["status"] == 1): ?>未查看<?php elseif($v["status"] == 2): ?>已回复<?php else: ?>已删除<?php endif; ?></td>
                            <td class="f-14 td-manage">
                                <a style="text-decoration:none" class="ml-5" href="/Admin/Content/show/id/<?php echo ($v["id"]); ?>/pid/<?php echo ($pid); ?>.html" title="回复"><i class="Hui-iconfont">回复</i></a>
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20" style="line-height: 35px;">
		...
		<?php if($page == 1): else: ?>
		<a href="/Admin/Content/index<?php echo ($str); ?>/page/1" class="paginate_button previous disabled" aria-controls="DataTables_Table_0" data-dt-idx="0" tabindex="0" id="DataTables_Table_0_previous">首页</a>
		<a href="/Admin/Content/index<?php echo ($str); ?>/page/<?php echo ($page-1); ?>" class="paginate_button previous disabled" aria-controls="DataTables_Table_0" data-dt-idx="0" tabindex="0" id="DataTables_Table_0_previous">上一页</a><?php endif; ?>
		<span>
        ...
        <?php if($page == $totalPage): else: ?>
            <a href="/Admin/Content/index<?php echo ($str); ?>/page/<?php echo ($page+1); ?>" class="paginate_button next disabled" aria-controls="DataTables_Table_0" data-dt-idx="2" tabindex="0" id="DataTables_Table_0_next">下一页</a>
            <a href="/Admin/Content/index<?php echo ($str); ?>/page/<?php echo ($totalPage); ?>" class="paginate_button next disabled" aria-controls="DataTables_Table_0" data-dt-idx="2" tabindex="0" id="DataTables_Table_0_next">尾页</a><?php endif; ?>
    </div>
    </span>
    </div>
    </div>
