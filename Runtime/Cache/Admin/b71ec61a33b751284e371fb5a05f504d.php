...
<article class="page-container">
	<form action="/Admin/Goods/goods_add.html" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>产品名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($mes["name"]); ?>" placeholder="" id="" name="name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">产品别名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($mes["nickname"]); ?>" placeholder="" id="" name="nickname">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="cid" class="select">
					<?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if($mes["cid"] == $v['id']): ?>selected="selected"<?php endif; ?>><?php echo ($v["cname"]); ?></option>
					<?php if(is_array($v["child"])): $i = 0; $__LIST__ = $v["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vv["id"]); ?>" <?php if($mes["cid"] == $vv['id']): ?>selected="selected"<?php endif; ?>>|--|--<?php echo ($vv["cname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
				</select>
				</span> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-4 col-sm-2">
				<input type="text" class="input-text" value="<?php echo ($mes["unit"]); ?>" placeholder="" id="" name="unit">
			</div>
			<div class="formControls col-xs-4 col-sm-2">
				/件
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-4 col-sm-2">
				<input type="text" class="input-text" value="<?php echo ($mes["price"]); ?>" placeholder="" id="" name="price">
			</div>
			<div class="formControls col-xs-4 col-sm-2">
				/元
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9" style="width: 13%;">
				<input type="text" class="input-text Wdate" value="<?php echo ($mes["product_date"]); ?>" placeholder="" id="" name="product_date" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>上市日期：</label>
			<div class="formControls col-xs-8 col-sm-9" style="width: 13%;">
				<input type="text" class="input-text Wdate" value="<?php echo ($mes["market_date"]); ?>" placeholder="" id="" name="market_date" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-thum-container">
					<div id="fileList" class="uploader-list"></div>
					 <input type="file" name="picture" style="display: none;" onchange="preview(this)">
					<button onclick="upload_one();" class="btn btn-default btn-uploadstar radius" type="button">开始上传</button>
					<?php if($mes["picture"] != ''): ?><div id="preview" style="display: block;padding-top: 12px;"><img width="100" height="100" src="<?php echo ($mes["picture"]); ?>"/></div> 
					<?php else: ?>
