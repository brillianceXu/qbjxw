...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 分类管理 <span class="c-gray en">&gt;</span> 添加分类 </nav>
<!-- <table class="table">
	<tr> -->
...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" method="post" action="/Admin/Goods/category_add/id/<?php echo ($mes["id"]); ?>.html"  enctype="multipart/form-data">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>分类名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($mes["cname"]); ?>" placeholder="" id="" name="cname">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				...
				<?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if($mes["pid"] == $v['id']): ?>selected="selected"<?php endif; ?>><?php echo ($v["cname"]); ?></option>
					<?php if(is_array($v["child"])): $i = 0; $__LIST__ = $v["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vv["id"]); ?>" <?php if($mes["pid"] == $vv['id']): ?>selected="selected"<?php endif; ?>>|--|--<?php echo ($vv["cname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
				</select>
				</span> </div>
		</div>
...
<!-- 		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="note" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！"><?php echo ($mes["note"]); ?></textarea>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<input type="hidden" name="status" value="<?php echo ($type); ?>"/>
...
<script type="text/javascript">
	function article_save(){
		...
		// var pid=$("select[name=pid]:selected").val();
	...
	{
		window.history.back();
		// window.location.href="/Category/category_list.html";
	}
	function upload_one()
    {
