...
<div class="page-container">
    <style type="text/css">
        #form-article-add label{
            width: 10%;
        }
    </style>
	<form action="/Admin/Banner/picture_add/id/<?php echo ($info["id"]); ?>.html" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>图片标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($info["name"]); ?>" placeholder="请输入标题" name="pname" >
			</div>
		</div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo ($info["link"]); ?>" placeholder="请输入包含http的完整网址" id="" name="link">
            </div>
        </div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
                <div id="uploader" class="wu-example">
                    ...
                    <div class="btns">
                        ...
                        <input type="file" name="route" id="doc" style="display: none;" onchange="preview(this);" value="">

                        <button id="ctlBtn" class="btn btn-default radius" type="button" onclick="$('#doc').click();">开始上传</button>
                        <div id="dd" style=" width:100%;"></div>
                        <?php if($info["route"] != ''): ?><div id="preview" style="display: block;padding-top: 12px;"><img height="100" src="<?php echo ($info["route"]); ?>"/></div> 
                        <?php else: ?>
