...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页  <span class="c-gray en">&gt;</span> 图片管理 <span class="c-gray en">&gt;</span> 图片管理  </nav>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			<thead>
				<tr class="text-c">
					...
					<!-- <th width="100">封面</th> -->
					<th width="150">分类缩略图</th>
					<!-- <th width="100">Tags</th> -->
					<th width="150">介绍</th>
					<!-- <th width="60">发布状态</th> -->
					<th width="100">操作</th>
					<!-- <th width="100">查看相册</th> -->
				</tr>
			</thead>
			<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c">
					...
					<td><?php echo ($v["id"]); ?></td>
					<td><a style="text-decoration:underline;" href="/Admin/Banner/album_view/id/<?php echo ($v["id"]); ?>.html"><?php echo ($v["cname"]); ?></a></td>
					<td><a  onclick="view_big('<?php echo ($v["picture"]); ?>','<?php echo ($v["cname"]); ?>');"><img src="<?php echo ($v["picture"]); ?>"></a></td>
					<!-- <td class="text-c"><?php echo ($v["keywords"]); ?></td> -->
					<td><?php echo ($v["note"]); ?></td>
					<!-- <td class="td-status"><span class="label label-success radius">已发布</span></td> -->
					<td class="td-manage">
						<a style="text-decoration:none" class="ml-5"  href="/Admin/Banner/album_edit/id/<?php echo ($v["id"]); ?>.html" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> 
					</td>
					<!-- <td><a style="text-decoration:underline;" onclick="view_big('<?php echo ($v["picture"]); ?>','<?php echo ($v["cname"]); ?>');"><?php echo ($v["cname"]); ?></a></td> -->
...
<div class="carrousel"> <span class="close entypo-cancel" onclick="close_big();">关闭</span>  
	<div class="divImg">
		<img src="images/" alt="BINGOO" style="height: 400px;width: auto;" /> 
