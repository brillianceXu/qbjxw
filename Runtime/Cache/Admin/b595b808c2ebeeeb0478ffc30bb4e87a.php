...
<div class="page-container" style="min-height: 400px;">
	<p class="f-20 text-success"><?php echo ($system["title"]); ?>网站后台管理系统<span class="f-14"></span></p>
	<!-- <p>登录次数：18 </p> -->
	<p>上次登录IP：<?php echo ($log["uip"]); ?>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;上次登录时间：<?php echo ($log["dotime"]); ?></p>
	<p><a href="/Public/usermanual.pdf" target="_blank" style="color: blue;"><?php echo ($system["title"]); ?>网站后台管理系统使用说明书</a></p>
