...
<section class="Hui-article-box">
    ...
    <div class="page-container">
        <form action="/Admin/Content/index/pageSize/<?php echo ($pageSize); ?>.html" method="get">
            <div class="text-c">
        ...
        <a class="btn btn-primary radius" data-title="添加" href="/Admin/Content/about_add.html"><i class="Hui-iconfont">&#xe600;</i> 添加</a></span>
                ...
                <form method="post" action="/Admin/Content/datadel" id="datadel_form">
                    <?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c">
                           ...
                           <!--  <td>
                            ...
                            <td class=""><a href="/index.php/Home/Business/index/id/<?php echo ($v["id"]); ?>.html" target="_blank"><u style="cursor:pointer" class="text-primary"  title="查看"><?php echo ($v["title"]); ?></u></a></td>
                            ...
                            <td class="f-14 td-manage">
                                ...
                                <a style="text-decoration:none" class="ml-5" href="/Admin/Content/about_add/id/<?php echo ($v["id"]); ?>.html" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
