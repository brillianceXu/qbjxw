...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页  <span class="c-gray en">&gt;</span> 图片管理 <span class="c-gray en">&gt;</span> Banner  </nav>
<div class="page-container">
        <form action="/Admin/Content/index<?php echo ($str); ?>.html" method="get">
            <div class="text-c">
                ...
                <button name="" id="" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 筛选</button>
                <!-- <a class="btn btn-primary" data-title="添加" href="/Admin/Content/article_add/pid/<?php echo ($pid); ?>.html"><i class="Hui-iconfont">&#xe600;</i> 添加</a> -->
                <!-- <button name="" id="" class="btn btn-primary" type="button" onclick="window.location.href='/Admin/Banner/picture_add.html';"><i class="Hui-iconfont">&#xe600;</i> 添加</button> -->
            </div>
        </form>
...
<div class="page-container" style="padding-top: 0px;">
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				<?php if(is_array($photos)): $i = 0; $__LIST__ = $photos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c">
					<td><input name="" type="checkbox" value=""></td>
					<td><?php echo ($v["id"]); ?></td>
					<td><a style="text-decoration:underline;" onclick="view_big('<?php echo ($v["route"]); ?>','<?php echo ($v["name"]); ?>');"><?php echo ($v["name"]); ?></a></td>
					<td><?php echo ($v["cname"]); ?></td>
					<td><?php echo ($v["link"]); ?></td>
					<!-- <td class="text-c"><?php echo ($v["keywords"]); ?></td> -->
					<!-- <td><?php echo ($v["content"]); ?></td> -->
					<!-- <td class="td-status"><span class="label label-success radius">已发布</span></td> -->
					<td class="td-manage">
						<a style="text-decoration:none" class="ml-5"  href="/Admin/Banner/picture_add/id/<?php echo ($v["id"]); ?>.html" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> 
...
function close_big(){
	...
	<div class="carrousel"> <span class="close entypo-cancel" onclick="close_big();">关闭</span>  
		<div class="divImg">
			...
			<img src="" alt="BINGOO" style="height: 300px;width: auto;" /> 
